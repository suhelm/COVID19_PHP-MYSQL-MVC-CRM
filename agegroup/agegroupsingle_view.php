...
//$key = $_GET['key'];
$query = "SELECT * FROM AGE_GROUP WHERE group_no='$key'";
...
<div class="container">
    ...
    <div class="main">
        ...
        <form method="post" action="../vaccine/update_vaccineform.php">
        ...
        <form method="POST" action="../vaccine/delete_vaccineform.php">
